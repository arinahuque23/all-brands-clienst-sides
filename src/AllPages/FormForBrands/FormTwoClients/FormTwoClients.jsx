                ...
                <form onSubmit={handleBrandClientProducts}>
                    ...
                    <div className="md:flex mb-8">
                        ...
                        <div className="form-control md:w-1/2 ml-4">
                            ...
                            <label className="input-group">
                                <select name="brandName" required className="input input-bordered w-full">
                    ...
                    <div className="md:flex mb-8">
                        ...
                        <div className="form-control md:w-1/2 ml-4">
                            ...
                            <label className="input-group">
                                <input type="number" name="rating" placeholder="rating" required className="input input-bordered w-full" step="0.5" min="1" max="5" />
                            </label>
                        </div>
                    </div>
                    {/* form Photo URL row */}
