    ...
    <>
      <div className="navbar bg-base-100 border shadow-sm">
          ...
          <div className="dropdown">
            ...
            >
              ...
              <li>
                <Link
                  to="/addproducts"
                  className="justify-between text-dark px-4"
                >
                  Add Product
                </Link>
              </li>
        ...
        <div className="navbar-center">
          <Link to="/">
            <img
              src="https://i.postimg.cc/rmsdZRMB/logo.png"
              className="md:w-45 w-32 mx-auto"
              alt="Logo"
            />
          </Link>
        </div>
                ...
                {user ? (
                  <>
                    ...
                    >
                      ...
                      <li>
                        <Link to="/addtoCart">My Cart</Link>
                      </li>
